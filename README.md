...
The official package <https://github.com/AppLovin/AppLovin-MAX-Swift-Package-IronSource.git> (tag `906000000.0.0`) depends on
...
Depend on this repository (`https://github.com/x3mads/xmediator-applovin-max-ironsource-swift-package.git`) at tag `906000000.0.0` and
